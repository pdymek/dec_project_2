...
from etl_project.assets.database_extractor import SqlExtractParser, DatabaseTableExtractor
from etl_project.connectors.postgresql import PostgreSqlClient
from graphlib import TopologicalSorter

def extract_load(template_environment: Environment, source_postgresql_client: PostgreSqlClient, target_postgresql_client: PostgreSqlClient):
    """
